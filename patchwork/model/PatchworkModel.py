...
class PatchworkModel():
	...
	def build_patch_list(self):
		...
		p3 = Patch(p3_array, 1, 2, 0)

		p4_r1 = [1, 1]
		p4_r2 = [1, 0]
		p4_r3 = [1, 1]
		p4_array = [p4_r1, p4_r2, p4_r3]
		p4 = Patch(p4_array, 1, 2, 0)
		...
		p6 = Patch(p6_array, 4, 2, 0)

		p7_r1 = [1, 0]
		p7_r2 = [1, 0]
		p7_r3 = [1, 1]
		p7_array = [p7_r1, p7_r2, p7_r3]
		p7 = Patch(p7_array, 4, 2, 1)

		p8_r1 = [0, 1, 0]
		p8_r2 = [1, 1, 1]
		p8_r3 = [1, 0, 1]
		p8_array = [p8_r1, p8_r2, p8_r3]
		p8 = Patch(p8_array, 3, 6, 2)

		p9_r1 = [0, 1]
		p9_r2 = [1, 1]
		p9_r3 = [0, 1]
		p9_array = [p9_r1, p9_r2, p9_r3]
		p9 = Patch(p9_array, 2, 2, 0)

		p10_r1 = [0, 1, 1, 0]
		p10_r2 = [1, 1, 1, 1]
		p10_array = [p10_r1, p10_r2]
		p10 = Patch(p10_array, 7, 4, 2)

		p11_r1 = [0, 1]
		p11_r2 = [1, 1]
		p11_r3 = [1, 0]
		p11_array = [p11_r1, p11_r2, p11_r3]
		p11 = Patch(p11_array, 3, 2, 1)

		p12_r1 = [0, 1]
		p12_r2 = [1, 1]
		p12_array = [p12_r1, p12_r2]
		p12 = Patch(p12_array, 1, 3, 0)

		p13_r1 = [0, 0, 1]
		p13_r2 = [0, 1, 1]
		p13_r3 = [1, 1, 0]
		p13_array = [p13_r1, p13_r2, p13_r3]
		p13 = Patch(p13_array, 10, 4, 3)

		p14_r1 = [1, 1, 1]
		p14_r2 = [0, 1, 0]
		p14_r3 = [1, 1, 1]
		p14_array = [p14_r1, p14_r2, p14_r3]
		p14 = Patch(p14_array, 2, 3, 0)
		...
		p15 = Patch(p15_array, 1, 4, 1)

		p16_r1 = [1, 1, 1]
		p16_array = [p16_r1]
		p16 = Patch(p16_array, 2, 2, 0)

		p17_r1 = [1, 1, 1, 1]
		p17_array = [p17_r1]
		p17 = Patch(p17_array, 3, 3, 1)
		...
		p19 = Patch(p19_array, 10, 5, 3)

		p20_r1 = [0, 1, 1, 1]
		p20_r2 = [1, 1, 0, 0]
		p20_array = [p20_r1, p20_r2]
		p20 = Patch(p20_array, 2, 3, 1)

		p21_r1 = [1, 0, 0, 1]
		p21_r2 = [1, 1, 1, 1]
		p21_array = [p21_r1, p21_r2]
		p21 = Patch(p21_array, 1, 5, 1)

		p22_r1 = [0, 0, 1, 0]
		p22_r2 = [1, 1, 1, 1]
		p22_r3 = [0, 1, 0, 0]
		p22_array = [p22_r1, p22_r2, p22_r3]
		p22 = Patch(p22_array, 2, 1, 0)

		p23_r1 = [0, 0, 0, 1]
		p23_r2 = [1, 1, 1, 1]
		p23_array = [p23_r1, p23_r2]
		p23 = Patch(p23_array, 10, 3, 2)

		p24_r1 = [1, 0, 0, 0]
		p24_r2 = [1, 1, 1, 1]
		p24_r3 = [1, 0, 0, 0]
		p24_array = [p24_r1, p24_r2, p24_r3]
		p24 = Patch(p24_array, 7, 2, 2)

		p25_r1 = [0, 1, 0]
		p25_r2 = [1, 1, 1]
		p25_r3 = [0, 1, 0]
		p25_array = [p25_r1, p25_r2, p25_r3]
		p25 = Patch(p25_array, 5, 4, 2)

		p26_r1 = [1, 1] 
		p26_r2 = [0, 1] 
		p26_r3 = [0, 1] 
		p26_array = [p26_r1, p26_r2, p26_r3]
		p26 = Patch(p26_array, 4, 6, 2)

		p27_r1 = [0, 1]
		p27_r2 = [1, 1]
		p27_r3 = [1, 1]
		p27_array = [p27_r1, p27_r2, p27_r3]
		p27 = Patch(p27_array, 2, 2, 0)

		p28_r1 = [0, 1, 1]
		p28_r2 = [1, 1, 0]
		p28_array = [p28_r1, p28_r2]
		p28 = Patch(p28_array, 7, 6, 3)

		p29_r1 = [0, 1]
		p29_r2 = [1, 1]
		p29_array = [p29_r1, p29_r2]
		p29 = Patch(p29_array, 3, 1, 0)

		p30_r1 = [0, 1, 0]
		p30_r2 = [0, 1, 0]
		p30_r3 = [1, 1, 1]
		p30_array = [p30_r1, p30_r2, p30_r3]
		p30 = Patch(p30_array, 5, 5, 2)

		p31_r1 = [1, 1]
		p31_r2 = [1, 1]
		p31_array = [p31_r1, p31_r2]
		p31 = Patch(p31_array, 6, 5, 2)

		p32_r1 = [1, 1, 1, 1, 1]
		p32_array = [p32_r1]
		p32 = Patch(p32_array, 7, 1, 1)

		p33_r1 = [1, 1]
		p33_array = [p33_r1]
		p33 = Patch(p33_array, 2, 1, 0)
