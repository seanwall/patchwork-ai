			...
			while self.running:
				...
				if self.model.game_over():
					...
					if self.model.p1_win() == 1:
						...
						self.ai.update_feature_weights(win_reward, 100, self.ai.get_state_utility(self.model.p1.quilt.patch_counts), self.model.p1.quilt.patch_counts)
						self.ai.update_feature_weights(lose_reward, -100, self.ai.get_state_utility(self.model.p2.quilt.patch_counts), self.model.p2.quilt.patch_counts)
						...
						#win/lose reward passed in as next state value, not sure if this is the right way to do this.
						self.ai.update_feature_weights(win_reward, 100, self.ai.get_state_utility(self.model.p2.quilt.patch_counts), self.model.p2.quilt.patch_counts)
						self.ai.update_feature_weights(lose_reward, -100, self.ai.get_state_utility(self.model.p1.quilt.patch_counts), self.model.p1.quilt.patch_counts)
